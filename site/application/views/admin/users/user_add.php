		...
		<div class="card">
			<div class="card-header d-flex p-0">
				...
				<ul class="nav nav-pills ml-auto p-2">
					<li class="nav-item ml-2"><a href="<?= base_url('admin/users'); ?>" class="btn btn-success"><i
									class="fad fa-list mr-2"></i><?= trans('users_list') ?></a></li>
				</ul>
			</div>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab_1">
						<div class="form">
							...
							<div class="form-group row">
								...
								<div class="col-md-10 col-sm-9">
									<select type="text" class="form-control" id="summary-input-type" tabindex="-1"
											aria-hidden="true" onchange="accountType(this.value)">
							...
							<div id="summary-company_type" style="display: none">
								<!-- COMPANY NAME -->
								<div class="form-group row">
									<label class="col-md-2 col-sm-3 col-form-label" for="company-name">Company
										Name</label>
									<div class="col-md-10 col-sm-9"><input type="text" class="form-control"
								...
								<!-- COMPANY VAT NUMBER -->
								<div class="form-group row">
									<label class="col-md-2 col-sm-3 col-form-label" for="company-vat-number">VAT
										Number</label>
									<div class="col-md-10 col-sm-9"><input type="text" class="form-control"
							...
							<!-- IDENTITY NUMBER -->
							<div class="form-group row">
								<label class="col-md-2 col-sm-3 col-form-label" for="profile-input-id-number">ID
									Number</label>
								<div class="col-md-10 col-sm-9"><input name="id_number" type="text" class="form-control"
																	   id="profile-input-id-number" autocomplete="off">
								</div>
							</div>
							<!-- NAME -->
							<div class="form-group row">
							...
							<?php if (!empty($this->general_settings['google_api_key'])) { ?>
								<div class="row">
									<div class="col-sm-7 col-md-6">
										...
										<div class="form-group row">
											<label class="col-sm-5 col-md-4 col-form-label" for="route">Street
												Address</label>
											<div class="col-sm-7 col-md-8"><input class="form-control" name="route"
																				  id="route" type="text"
																				  autocomplete="off"></div>
										</div>
										<div class="form-group row">
											<label class="col-sm-5 col-md-4 col-form-label" for="locality">City</label>
											<div class="col-sm-7 col-md-8"><input class="form-control" name="locality"
																				  id="locality" type="text"
																				  autocomplete="off"></div>
										</div>
										<div class="form-group row">
											<label class="col-sm-5 col-md-4 col-form-label"
										...
										<div class="form-group row">
											<label class="col-sm-5 col-md-4 col-form-label" for="postal_code">Postal
												Code</label>
											<div class="col-sm-7 col-md-8"><input class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-7 col-md-8"><input class="form-control" name="country"
									...
									<div class="col-sm-5 col-md-6">
										<div id="google-map"
											 style="border: 1px solid rgb(204, 204, 204); border-radius: 4px; height: 284px; width: 100%; overflow: hidden;"></div>
										<small>Drag the marker to mark the exact location on the map.</small>
										<input name="marker_gps_coordinates"
											   class="form-control ml-0 mt-0 no-border font-size-0 bg-transparent border-transparent"
											   id="marker_gps_coordinates" type="text" autocomplete="off" readonly
											   disabled hidden>
									</div>
								</div>
							<?php } ?>
							...
							<div class="form-group row">
								...
								<div class="col-md-10 col-sm-9">
									<div class="input-group">
										<input class="form-control" name="gps_coordinates" id="gps_coordinates"
								...
								<div class="col-md-10 col-sm-9">
									<div class="input-group">
										<input name="account_code" type="text" class="form-control"
											   id="profile-input-account-code" autocomplete="off" value="" required>
										<span class="input-group-append"><button id="account_code_btn"
																				 onclick="generateAccountCode()"
																				 type="button"
																				 class="btn btn-default btn-flat">Generate</button></span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="tab_2">
						<div class="row m-0 mb-4">
							<input data-toggle="switch" class="tgl_checkbox" data-id="data_account" id="cb_data_account"
								   type="checkbox"
						...
						<form>
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label"
									   for="portal_username"><?= trans('username') ?></label>
								<div class="col-sm-10">
									<input name="portal_username" type="text" class="form-control" id="portal_username"
										   placeholder="" autocomplete="off" value="" required>
								</div>
							</div>
							<!-- PASSWORD -->
							<div class="form-group row">
								<label class="col-sm-2 col-form-label"
									   for="portal_password"><?= trans('password') ?></label>
								<div class="col-sm-10">
									<input type="password" name="portal_password" class="form-control"
										   id="portal_password" placeholder="">
								</div>
							</div>
						</form>
					</div>
