                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="company_name" class="form-control" id="company_name" value="<?= $this->general_settings['company_name'] ?>" placeholder="" required>
                      </div>
                      
                      <div class="form-group">
                        <label for="address1" class="control-label"><?= trans('address_line') ?>1</label>
                        <input type="text" name="company_address_1" class="form-control" id="address1" value="<?= $this->general_settings['address_line_1'] ?>" placeholder="" required>
                      </div>

                      <div class="form-group">
                        <label for="address2" class="control-label"><?= trans('address_line') ?>2</label>
                        <input type="address2" name="company_address_2" class="form-control" id="address2" value="<?= $this->general_settings['address_line_2'] ?>" placeholder="" >
                      </div>
                      <div class="form-group">
                        <label for="email" class="control-label"><?= trans('email') ?></label>
                        <input type="email" name="company_email" class="form-control" id="" value="<?= $this->general_settings['email_address'] ?>" placeholder="" required>
                      </div>
                      <div class="form-group">
                        <label for="mobile_no" class="control-label"><?= trans('mobile_no') ?></label>
                        <input type="tel" name="company_mobile_no" class="form-control" id="" value="<?= $this->general_settings['contact_number'] ?>" placeholder="" required>
                      </div>
              ...
              <div class="col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="mobile_no" class="control-label"><?= trans('mobile_no') ?></label>
                        <input type="tel" name="mobile_no" class="form-control" id="mobile_no" placeholder="" required>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="invoice_no" class="form-control" id="invoice_no" placeholder="eg. Inv-1001" required value="<?= get_new_invoice_number(); ?>">
                        </div>
                      </div>
                      <div class="col-md-3">
                  ...
                  <div class="card-body">
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="termsncondition" class="form-control" rows="3" placeholder="" ><?= $this->general_settings['terms'] ?></textarea>
                      </div>
                  </div>
                </div>
              </div>
