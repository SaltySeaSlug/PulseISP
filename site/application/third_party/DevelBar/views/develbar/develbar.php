...
<div class="develbar" id="develbar-container" style="z-index: 9999">
...
<div onclick="ShowDevelBar()" id="develbar-off" style="z-index: 9999"><img src="<?php echo $logo ?>" alt="CodeIgniter" />
